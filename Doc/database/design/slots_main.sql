...
CREATE TABLE IF NOT EXISTS `t_account` (
  ...
  `openid` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '平台账号ID',
  `platform` tinyint(1) unsigned NOT NULL COMMENT '账号所属平台',
  `bindGuest` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '绑定的游客ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COMMENT='用户账号表';
...
CREATE TABLE IF NOT EXISTS `t_user` (
  ...
  `vipPts` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT 'VIP积分',
  `recharge` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '付费总额',
...
CREATE TABLE IF NOT EXISTS `t_analysis` (
  ...
  `lastBet` bigint(20) unsigned DEFAULT '0' COMMENT '上次bet值',
  `recentAvgBet` bigint(20) unsigned DEFAULT '0' COMMENT '最近的平均bet值',
  `commonUsedBet` bigint(20) unsigned DEFAULT '0' COMMENT '最近的常用bet值',
...
CREATE TABLE IF NOT EXISTS `t_recharge` (
  `uid` int(10) unsigned NOT NULL COMMENT '购买者ID',
  `amount` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '充值总金额',
  ...
  `maxAmount` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '单次最大充值金额',
  `mostAmount` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '充值次数最多的金额',
  `lastAmount` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '最后一次充值金额',
