...
var JSONFormat = (function () {
    ...
    function _format_array(object, indent_count) {
        ...
        return '<span data-type="array" data-size="' + tmp_array.length + '"><i  style="cursor:pointer;" class="fa fa-minus-square-o" onclick="hideJsonTree(this)"></i> [<br/>'
            + tmp_array.join(',<br/>')
    ...
    function _format_object(object, indent_count) {
        ...
        return '<span  data-type="object"><i  style="cursor:pointer;" class="fa fa-minus-square-o" onclick="hideJsonTree(this)"></i> {<br/>'
            + tmp_array.join(',<br/>')
            + '<br/>' + indent_tab(indent_count - 1) + '}</span>';
    }
    ...
    function loadCssString() {
        ...
        try {
            style.append(document.createTextNode(code));
        } catch (ex) {
...
function hideJsonTree(obj) {
    ...
    if (data_type === 'array') {
        obj.parentNode.innerHTML = '<i style="cursor:pointer;" class="fa fa-plus-square-o" onclick="showJsonTree(this)"></i> Array [<span class="json_number">' + data_size + '</span>]';
    } else {
        obj.parentNode.innerHTML = '<i style="cursor:pointer;" class="fa fa-plus-square-o" onclick="showJsonTree(this)"></i> Object {...}';
    }
}
