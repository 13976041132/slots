...
(select sum(totalCoin) totalCoin, count(1) as times, sum(totalReward) totalReward,JSON_ARRAYAGG(JSON_OBJECT('id', {$coinItem}, 'num', totalReward)) as itemList, JSON_ARRAYAGG(JSON_OBJECT('uid', uid, 'times', totalCoin)) as extData, clubId  from (
