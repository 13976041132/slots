...
(select sum(totalCoin) totalCoin, count(1) as times ,JSON_ARRAYAGG(JSON_OBJECT('id', {$coinItem}, 'num', sum(totalReward))) as itemList, JSON_ARRAYAGG(JSON_OBJECT('uid', uid, 'times', totalCoin)) as extData, clubId  from (
